 ...
 * 
 */
@WebServiceClient(name = "NewWebService", targetNamespace = "http://netsixService/", wsdlLocation = "http://localhost:8080/NetSixServer/NewWebService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName NEWWEBSERVICE_QNAME = new QName("http://netsixService/", "NewWebService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/NetSixServer/NewWebService?wsdl");
    ...
    public NewWebService getNewWebServicePort() {
        return super.getPort(new QName("http://netsixService/", "NewWebServicePort"), NewWebService.class);
    }
    ...
    public NewWebService getNewWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://netsixService/", "NewWebServicePort"), NewWebService.class, features);
    }
